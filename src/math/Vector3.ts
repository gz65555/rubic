...
export class Vector3 implements IClone {
	 ...
	 * @param	result 输出三维向量。
	 */
	static transformV3ToV3(vector: Vector3, transform: Matrix4, result: Vector3): void {
	 ...
	 * @param	result 输出四维向量。
	 */
	static transformV3ToV4(vector: Vector3, transform: Matrix4, result: Vector4): void {
	 ...
	 */
	static TransformNormal(normal: Vector3, transform: Matrix4, result: Vector3): void {
	 ...
	 * @param	result 输出三维向量。
	 */
	static transformCoordinate(coordinate: Vector3, transform: Matrix4, result: Vector3): void {
