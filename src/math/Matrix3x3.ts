...
export class Matrix3 implements IClone {
  ...
  static createRotationQuaternion(rotation: Quaternion, out: Matrix3) {
   ...
   * @param	out 输出矩阵
   */
  static createFromTranslation(trans: Vector2, out: Matrix3): void {
   ...
   * @param	out 输出矩阵
   */
  static createFromScaling(scale: Vector3, out: Matrix3): void {
    var e: Float32Array = out.elements;
   ...
   * @param	out 3x3输出矩阵
   */
  static createFromMatrix4x4(sou: Matrix4, out: Matrix3): void {
   ...
   * @param	out 输出矩阵
   */
  translate(trans: Vector2, out: Matrix3): void {
    var e: Float32Array = out.elements;
    var f: Float32Array = this.elements;
   ...
   * @param	out 输出矩阵
   */
  rotate(rad: number, out: Matrix3): void {
    var e: Float32Array = out.elements;
    var f: Float32Array = this.elements;
   ...
   * @param	out 输出矩阵
   */
  scale(scale: Vector2, out: Matrix3): void {
    var e: Float32Array = out.elements;
    var f: Float32Array = this.elements;
  ...
  static lookAt(eye: Vector3, target: Vector3, up: Vector3, out: Matrix3): void {
    ...
    Vector3.normalize(Matrix3._tempV31, Matrix3._tempV31);

    Vector3.cross(Matrix3._tempV30, Matrix3._tempV31, Matrix3._tempV32);

    var v0: Vector3 = Matrix3._tempV30;
    var v1: Vector3 = Matrix3._tempV31;
    var v2: Vector3 = Matrix3._tempV32;
